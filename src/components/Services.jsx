    ...
    <section id="hizmetler" className="services">
      <div className="container">
        ...
        <div ref={rGrid} className="services__grid reveal-up">
          {services.map((s, i) => (
            <div className="service-card" key={i}>
              <div className="service-card__icon"><ServiceIcon paths={s.iconPaths} /></div>
        ...
        <div ref={rBanner} className="services__image-banner reveal-up">
          <img src="/assets/services.jpeg" alt="Çocuklarla İletişim" />
        </div>
      </div>
      ...
      <div className={`modal-overlay ${open !== null ? 'active' : ''}`} onClick={() => setOpen(null)}>
        {open !== null && (
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-icon"><ServiceIcon paths={services[open].iconPaths} /></div>
