export const services = [
  {
    title: 'Sağlam Çocuk Takibi',
    desc: 'Bebeğinizin büyüme ve gelişimini düzenli aralıklarla takip ediyoruz. Boy, kilo, baş çevresi ölçümleri ve gelişim tarama testleriyle her aşamada yanınızdayız.',
    details: 'Sağlam çocuk takibi, çocukların henüz hiçbir hastalık belirtisi göstermediği dönemlerde, fiziksel, zihinsel ve sosyal gelişimlerini değerlendirmek amacıyla yapılan düzenli sağlık kontrolleridir. Kliniğimizde, bebeğinizin doğumundan itibaren boy, kilo ve baş çevresi ölçümleri persentil eğrilerinde izlenir. Motor, dil ve bilişsel gelişim basamakları yaşlarına uygun olarak değerlendirilir. Ayrıca uyku düzeni, tuvalet eğitimi ve kazalardan korunma gibi konularda ailelere rehberlik edilir. Rutin sağlam çocuk kontrolleri; bebeğin ilk aylarında daha sık (aylık) olmak üzere, ilerleyen yaşlarda çocuğunuzun ihtiyacına göre planlanarak koruyucu hekimliğin en önemli parçasını oluşturur.',
  ...
  },
  {
    ...
    desc: 'Yeni doğan bebeğinizin ilk günlerinden itibaren detaylı muayene, sarılık takibi, metabolik tarama ve anne-bebek bağlanması konularında destek sunuyoruz.',
    details: 'Yenidoğan dönemi, bebeğin anne karnından dış dünyaya uyum sağladığı en hassas süreçtir. Doğum sonrası kliniğimizde yapılan ilk muayenelerde bebeğin refleksleri, kalp sesleri, solunumu, kalça eklemleri ve genel anatomik yapısı detaylıca incelenir. İlk haftalarda sık karşılaşılan yenidoğan sarılığı yakından takip edilir, gerekirse bilirubin ölçümleri ile değerlendirilir. Erken dönemde yapılan işitme taraması ve topuk kanı (metabolik tarama) testlerinin takibi yapılır. Ayrıca emzirme teknikleri, göbek kordonu bakımı, gaz sancısı (kolik) ve anne-bebek bağlanması süreçlerinde ailelere kesintisiz destek sağlanır.',
    iconPaths: ['M9 12h.01', 'M15 12h.01', 'M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5', 'M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3.5 1.1 3.5 2.5s-.9 2.5-2 2.5c-.8 0-1.5-.4-1.5-1']
  },
  {
  ...
  },
  {
    ...
    desc: 'Üst solunum yolu enfeksiyonları, kulak iltihabı, ishal ve diğer çocukluk çağı hastalıklarında hızlı tanı ve etkili tedavi uyguluyoruz.',
    details: 'Çocukluk çağında sık karşılaşılan ateşli durumlar aileleri en çok endişelendiren konulardandır. Üst ve alt solunum yolu enfeksiyonları (grip, bronşit, zatürre), bademcik ve kulak iltihapları, idrar yolu enfeksiyonları ve ishal gibi hastalıklarda doğru ve hızlı teşhis hayat kurtarır. Kliniğimizde gereksiz antibiyotik kullanımından kaçınılarak, kanıta dayalı tıp ışığında rasyonel tedaviler uygulanır. Ailelere evde ateş takibinin nasıl yapılacağı, hangi durumlarda acile başvurulması gerektiği ve ateş düşürücülerin doğru kullanımı hakkında kapsamlı bilgiler verilir.',
    iconPaths: ['M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z']
  },
  {
...
export const diseases = [
  ...
  'Kulak ve Bademcik Hastalıkları',
  'Gaz Sancısı (Kolik)',
